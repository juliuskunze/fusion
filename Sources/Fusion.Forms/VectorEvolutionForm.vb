Public Class VectorEvolutionForm
    ...
    Private Sub _Strategy_BestSolutionImproved(sender As Object, e As Evolution.SolutionEventArgs(Of Math.Vector2D)) Handles _Strategy.BestSolutionImproved
        _Renderer.Render()
    End Sub

    Private Sub pbx_MouseMove(sender As Object, e As System.Windows.Forms.MouseEventArgs)
        _ViewController.ScreenMouseLocation = New Vector2D(e.Location)
        _Renderer.Render()
    End Sub

    Private Const _DeltaPerMouseWheelStep As Double = 120
    Private Sub pbx_MouseWheel(sender As Object, e As System.Windows.Forms.MouseEventArgs)
