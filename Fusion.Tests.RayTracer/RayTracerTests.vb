Public Class RayTracerTests
    ...
    Public Sub Reflection()
        Dim reflectingSphere = New MaterialSurface(Of Material2D(Of RgbLight))(New Sphere(center:=New Vector3D(-1, 0, 0), radius:=1),
        ...
        Dim colorSphere = New MaterialSurface(Of Material2D(Of RgbLight))(New Sphere(center:=New Vector3D(3, -3, 0), radius:=1),
