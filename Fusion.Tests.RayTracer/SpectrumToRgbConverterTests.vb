Public Class SpectrumToRgbConverterTests
    ...
    Public Class SpectrumToRgbConverterFactoryTests
        ...
        Public Sub TestPrimary()
            ...
            Dim blue = converter.ConvertMonochromatic(wavelength:=SpectrumToRgbConverter.BlueWavelength, intensity:=0.5)
            ...
            Dim green = converter.ConvertMonochromatic(wavelength:=SpectrumToRgbConverter.GreenWavelength, intensity:=0.5)
            ...
            Dim red = converter.ConvertMonochromatic(wavelength:=SpectrumToRgbConverter.RedWavelength, intensity:=0.5)
