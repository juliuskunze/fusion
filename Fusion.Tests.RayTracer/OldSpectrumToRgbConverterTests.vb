Public Class OldSpectrumToRgbConverterTests

    Private _Converter As OldSpectrumToRgbConverter = New OldSpectrumToRgbConverter(testStepCount:=25)

    <Test()>
    Public Sub TestPrimary()
        Dim blue = _Converter.GetIntensityPerWavelength(wavelength:=OldSpectrumToRgbConverter.BlueWavelength, intensity:=0.5)
        ...
        Dim green = _Converter.GetIntensityPerWavelength(wavelength:=OldSpectrumToRgbConverter.GreenWavelength, intensity:=0.5)
        ...
        Dim red = _Converter.GetIntensityPerWavelength(wavelength:=OldSpectrumToRgbConverter.RedWavelength, intensity:=0.5)
