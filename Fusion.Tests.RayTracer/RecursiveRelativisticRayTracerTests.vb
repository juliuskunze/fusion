Public Class RecursiveRelativisticRayTracerTests
    ...
    Public Sub Searchlight()
        ...
        Assert.Greater(GetTestScene(spectrum).GetLight(New Ray(New Vector3D, New Vector3D(1, 0, 0))).Function(1), spectrum(1))
    End Sub
    ...
    Private Function GetTestScene(spectrum As SpectralRadianceFunction) As RecursiveRelativisticRayTracer
        ...
        Return New RecursiveRelativisticRayTracer(observerTime:=0, referenceFrames:={frame}, options:=New LorentzTransformationAtSightRayOptions)
    End Function
