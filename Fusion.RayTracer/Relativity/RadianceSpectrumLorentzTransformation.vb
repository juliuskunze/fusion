Public Class RadianceSpectrumLorentzTransformation
    ...
    Public Function TransformSpectralRadianceFunction(normalizedSightRayDirectionInS As Vector3D, spectralRadianceFunction As SpectralRadianceFunction) As SpectralRadianceFunction
        ...
        If _Options.IgnoreSearchlightEffect Then Return Function(wavelengthInT) spectralRadianceFunction(_Transformation.Inverse.AtSightRayDirection(normalizedSightRayDirectionInS).TransformWavelength(wavelength:=wavelengthInT))
        If _Options.IgnoreDopplerEffect Then Return Function(wavelengthInT) _Transformation.AtSightRayDirection(normalizedSightRayDirectionInS).TransformSpectralRadiance(spectralRadiance:=spectralRadianceFunction(wavelengthInT))

        Return _Transformation.AtSightRayDirection(normalizedSightRayDirectionInS).TransformSpectralRadianceFunction(spectralRadianceFunction:=spectralRadianceFunction)
    End Function
End Class
