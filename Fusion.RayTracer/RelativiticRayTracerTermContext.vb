...
Public NotInheritable Class RelativiticRayTracerTermContext
    ...
    Private Shared ReadOnly _SphereConstructor As New FunctionInstance(
        ...
        invokableExpression:=CType(Function(center As Vector3D, radius As Double) New Sphere(center:=center, radius:=radius), Expression(Of Func(Of Vector3D, Double, Sphere))))
