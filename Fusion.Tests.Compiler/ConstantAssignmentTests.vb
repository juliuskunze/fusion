Public Class ConstantAssignmentTests
    ...
    <Test()>
    Public Sub Test3()
        Dim d = New ConstantAssignment(Definition:="Real b = (a+2)/4", context:=New TermContext(constants:={New ConstantAssignment(Definition:="Real a = 2", context:=TermContext.Default).GetNamedConstantExpression}, types:=NamedTypes.Default))
    ...
    Public Sub TestCollection()
        Dim d = New ConstantAssignment(Definition:="Collection[Real] c = {1,2}", context:=TermContext.Default)
