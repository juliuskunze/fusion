Public Class TermContext
    ...
    Private Shared ReadOnly _Default As New TermContext(Constants:={New ConstantInstance(Of Boolean)("true", True, TypeDictionary.Default, "A Boolean value that passes a conditional test."),
                                                        ...
                                                        Functions:={New FunctionInstance(Of Func(Of Double, Double))("Sqrt", Function(x As Double) System.Math.Sqrt(x), TypeDictionary.Default, "The square root of a real number."),
                                                                    ...
                                                                    New FunctionInstance(Of Func(Of Double, Double, Double))("Mod", Function(x, modulo) NonnegativeMod(x, modulo), TypeDictionary.Default, "Returns the number modulo the specifed other number. (0 <= result < modulo)."),
                                                                    New FunctionInstance(Of Func(Of Double, Double, Double))("NormalizedMod", Function(x, modulo) NonnegativeNormalizedMod(x, modulo), TypeDictionary.Default, "Returns the number modulo the specifed other number divided by the second number. (0 <= result < modulo)."),
