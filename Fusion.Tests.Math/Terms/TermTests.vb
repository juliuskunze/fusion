Public Class TermTests
    ...
    Public Sub TestFunction()
        Dim namedMethodExpression = New NamedFunction(New NamedDelegateType("square", NamedType.Real, {New NamedParameter(name:="x", Type:=NamedType.Real)}), ExpressionBuilder:=NamedFunction.GetFunctionExpressionBuilder(Of Func(Of Double, Double))(lambdaExpression:=Function(x As Double) x ^ 2))
